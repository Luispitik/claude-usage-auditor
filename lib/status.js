...
// Markers independientes del nombre del directorio (ver lib/config.js)
const HOOK_MARKERS = ['/hooks/tracker.js', '/hooks/session-start.js'];
...
function main() {
  ...
  console.log('    /productivity-goals          → definir objetivos del proyecto');
  console.log('    /productivity-status         → este diagnóstico');
  console.log('    /productivity-install        → instalar hooks');
  console.log('    /productivity-uninstall      → quitar hooks (--purge para datos)');
}
